...
def main():
    ...
    # SAVE_WORKER_MODEL_PATH: Optional[str] = "logs/exp_hrl_worker_1/worker/worker_model.pkl"
    # SAVE_WORKER_ENV_PATH: Optional[str] = "logs/exp_hrl_worker_1/worker/vecnormalize.pkl"
